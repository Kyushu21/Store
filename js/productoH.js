...
function obtenerParametroURL(nombre) {
  ...
  function obtenerDescripcionProducto(nombreProductoH) {
    switch (nombreProducto) {
      case "Falda Blanca":
        return "Camiseta blanca de punto con manga abullonada";
      case "producto2":
        return "Descripcion del producto 2 HAHA";
      //Agrega mas casos segun sea necesario para cada producto
      default:
        ...
        <div class="product-imgs">
          <div class="img-display">
            <div class="img-showcase">
              <img
                src="../css/img-tienda/Hombre/${nombreProducto}.jpg"
              />
              <!--Poner mas imagenes-->
              <img
                src="../css/img-tienda/Hombre/${nombreProducto}.jpg"
  ...
  function volverAProductos() {
    window.location.href = "hombre.html"; //redirige a la pagina principal de productos
  }
  ...
  function verProducto(nombreProducto) {
    window.location.href = `productoH.html?producto=${nombreProducto}`; //Redirige a la página del producto con el nombre del producto como parametro
  }